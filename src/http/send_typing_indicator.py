...
async def send_typing_indicator(post_func, get_user_info_func, ctx: Any, thread_id: str, is_typing: bool, is_group: Optional[bool] = None):
    async def make_typing_indicator(typ: bool, t_id: str, group: Optional[bool]):
        ...
        res = await post_func("https://www.facebook.com/ajax/messaging/typ.php", ctx, form)
