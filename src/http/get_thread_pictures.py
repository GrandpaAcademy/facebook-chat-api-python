...
async def get_thread_pictures(post_func, ctx: Any, thread_id: str, offset: int, limit: int):
    ...
    async def get_image_detail(image_fbid):
        ...
        try:
            ...
            query_thread_id = detail_data["jsmods"]["require"][0][3][1]["query_metadata"]["query_path"][0]["message_thread"]
            image_info = detail_data["jsmods"]["require"][0][3][1]["query_results"][query_thread_id]["message_images"]["edges"][0]["node"]["image2"]
            return image_info
