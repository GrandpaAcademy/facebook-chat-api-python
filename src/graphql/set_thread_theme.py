...
async def set_thread_theme(ctx: Any, thread_id: str, theme_fbid: str):
    ...
    def make_task(label, queue_name, extra_payload=None):
        ...
        task = {
            ...
            "queue_name": queue_name if isinstance(queue_name, str) else json.dumps(queue_name),
    ...
    tasks_configs = [
        ...
        {"label": 43, "queue": "thread_theme", "extra": {"source": None, "payload": None}},
    ]
    ...
    for config in tasks_configs:
        ...
        msg = {
            ...
            "payload": json.dumps({
                ...
                "tasks": [make_task(config["label"], config["queue"], config.get("extra"))],
